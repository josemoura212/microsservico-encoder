...
func (j *JobService) Start() error {
	...
	err = j.VideoService.Download(os.Getenv(EnvInputBucketName))
...
func (j *JobService) performUpload() error {
	...
	videoUpload.OutputBucket = os.Getenv(EnvOutputBucketName)
	videoUpload.VideoPath = os.Getenv(EnvLocalStoragePath) + "/" + j.VideoService.Video.ID
	concurrency, _ := strconv.Atoi(os.Getenv(EnvConcurrencyUpload))
